<template>
	<div>
		<div class="entry-list">
			<entry id="spot" label="Spot" v-model="spot" wlabel="5rem" wvalue="5rem"></entry>
		</div>
		<div class="Market Quotes">
			<input-quotes id="input_data" @calibrate="calibrate"></input-quotes>
		</div>
	</div>
</template>
