...
public class FxDragDropExample1 extends Application
{
	...
	public void start(Stage stage)
	{
		...
		sourceFld.setOnMouseDragEntered(new EventHandler <MouseDragEvent>()
		{
		...
		sourceFld.setOnMouseDragOver(new EventHandler <MouseDragEvent>()
		{
			public void handle(MouseDragEvent event)
			{
		...
		sourceFld.setOnMouseDragReleased(new EventHandler <MouseDragEvent>()
		{
			public void handle(MouseDragEvent event)
			{
		...
		sourceFld.setOnMouseDragExited(new EventHandler <MouseDragEvent>()
		{
			public void handle(MouseDragEvent event)
			{
